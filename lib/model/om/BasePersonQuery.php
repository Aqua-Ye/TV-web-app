 ...
 * @method     PersonQuery orderByFname($order = Criteria::ASC) Order by the fname column
 * @method     PersonQuery orderByLname($order = Criteria::ASC) Order by the lname column
 *
 * @method     PersonQuery groupById() Group by the id column
 * @method     PersonQuery groupByFname() Group by the fname column
 * @method     PersonQuery groupByLname() Group by the lname column
 *
 ...
 * @method     Person findOneByFname(string $fname) Return the first Person filtered by the fname column
 * @method     Person findOneByLname(string $lname) Return the first Person filtered by the lname column
 *
 * @method     array findById(int $id) Return Person objects filtered by the id column
 * @method     array findByFname(string $fname) Return Person objects filtered by the fname column
 * @method     array findByLname(string $lname) Return Person objects filtered by the lname column
 *
...
abstract class BasePersonQuery extends ModelCriteria
{
	 ...
	 */
	public function __construct($dbName = 'propel', $modelName = 'Person', $modelAlias = null)
	{
	...
	{
		$sql = 'SELECT `ID`, `FNAME`, `LNAME` FROM `person` WHERE `ID` = :p0';
		try {
		...
		if ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$obj = new Person();
			$obj->hydrate($row);
			PersonPeer::addInstanceToPool($obj, (string) $row[0]);
		}
		$stmt->closeCursor();
	...
	public function filterByFname($fname = null, $comparison = null)
	{
		...
		return $this->addUsingAlias(PersonPeer::FNAME, $fname, $comparison);
	}
	...
	public function filterByLname($lname = null, $comparison = null)
	{
		...
		return $this->addUsingAlias(PersonPeer::LNAME, $lname, $comparison);
	}
