...
abstract class BasePerson extends BaseObject  implements Persistent
{
	...
	public function setFname($v)
	{
		...
		if ($this->fname !== $v) {
			$this->fname = $v;
			$this->modifiedColumns[] = PersonPeer::FNAME;
		}
	...
	public function setLname($v)
	{
		...
		if ($this->lname !== $v) {
			$this->lname = $v;
			$this->modifiedColumns[] = PersonPeer::LNAME;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = PersonPeer::NUM_HYDRATE_COLUMNS.
	...
	protected function doInsert(PropelPDO $con)
	{
		...
		if ($this->isColumnModified(PersonPeer::FNAME)) {
			$modifiedColumns[':p' . $index++]  = '`FNAME`';
		}
		if ($this->isColumnModified(PersonPeer::LNAME)) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(PersonPeer::FNAME)) $criteria->add(PersonPeer::FNAME, $this->fname);
		if ($this->isColumnModified(PersonPeer::LNAME)) $criteria->add(PersonPeer::LNAME, $this->lname);
	...
	public function __call($name, $params)
	{
		...
		// symfony_behaviors behavior
		if ($callable = sfMixer::getCallable('BasePerson:' . $name))
		{
