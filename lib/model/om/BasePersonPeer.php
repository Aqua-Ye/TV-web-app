...
abstract class BasePersonPeer {
	...
	protected static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Fname', 'Lname', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'fname', 'lname', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::FNAME, self::LNAME, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'FNAME', 'LNAME', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'fname', 'lname', ),
	...
	protected static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Fname' => 1, 'Lname' => 2, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'fname' => 1, 'lname' => 2, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::FNAME => 1, self::LNAME => 2, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'FNAME' => 1, 'LNAME' => 2, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'fname' => 1, 'lname' => 2, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, )
	);
	...
	public static function addSelectColumns(Criteria $criteria, $alias = null)
	{
		if (null === $alias) {
			...
			$criteria->addSelectColumn(PersonPeer::FNAME);
			$criteria->addSelectColumn(PersonPeer::LNAME);
		} else {
